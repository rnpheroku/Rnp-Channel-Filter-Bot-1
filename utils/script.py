...
I am **Thunder Filter Bot**.I am best Channel Link Search Bot! 
...
- Send /verify in group & wait for It To Accept Or Directly Contact To Owner After Request @MrRnp.
...
Get connected channels list with - /connections"""
    ...
    ABOUT = """Developed By @MrRnp

✯ Mʏ Nᴀᴍᴇ:  {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/MrRnp'>MrRnp</a>
